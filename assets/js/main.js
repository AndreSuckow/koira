...
$(function () {
    ...
    contactForm.validate({
        ...
        submitHandler: function (contactForm) {
            $(contactResult, contactForm).html('Enviando seu e-mail...');
            $.ajax({
                type: "POST",
                ...
                success: function (msg) {
                    $(contactResult, contactForm).html('<div class="alert alert-success" role="alert"><strong>Obrigado. Você será contato em breve.</strong></div>').delay(3000).fadeOut(2000);
                },
                error: $('.thanks').show()
            });
            return false;
